...
{
    /// <summary>
    /// an adorner that displays the the content that is dragged according to a data template
    /// </summary>
	public class DraggedAdorner : Adorner
	{
		...
		public DraggedAdorner(object dragDropData, DataTemplate dragDropTemplate, AdornerLayer adornerLayer, UIElement adornedElement)
			: base(adornedElement)
		{
